...
if (statsSection && stats.length > 0) {
    ...
    const produtos = {
        ...
        construcao: [
            ...
            { img: 'https://res.cloudinary.com/dhsg68f5x/image/upload/v1778071265/OIP_2_sc04jk.webp', nome: 'Electródo', desc: 'Electródo' },
...
function gerarTabelaDinamica(especificacoes, colunas) {
    ...
    const subcategoriasData = {
        ...
        construcao: [
            { id: 'cons1', nome: '1. VARÕES DE AÇO' },
            { id: 'cons2', nome: '2. POSTES DE MADEIRA' },
            { id: 'cons3', nome: '3. POSTES DE BETÃO' },
            { id: 'cons4', nome: '4. ARAME' },
            { id: 'cons5', nome: '5. ELÉCTRODOS' },
            { id: 'cons6', nome: '6. PREGOS' },
            { id: 'cons7', nome: '7. CHAPAS' },
            { id: 'cons8', nome: '8. TUBO DE FERRO' },
            { id: 'cons9', nome: '9. RIPAS, PRANCHAS E VIGAS' },
            { id: 'cons10', nome: '10. CONTRAPLACADO' },
        ],
        canalizacao: [
