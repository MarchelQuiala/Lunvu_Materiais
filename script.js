...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dadosProdutos = {
        ...
        'elet1': [
            { nome: 'Berço de Guiamento com Espigão', desc: 'Berço de Guiamento', Material: 'Espigão em aço electrozincado (AZ) ou galvanizado (AG)', Código: '9113000110', Tipo: 'BE AZ 16', Secção: '26516' },
