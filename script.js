...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dadosProdutos = {
        ...
        'elet1': [
            { nome: 'Berço de Guiamento com Espigão', desc: 'Conector tipo cunha para cabos de alumínio', Material: 'Espigão em aço electrozincado (AZ) ou galvanizado (AG)', Código: '9113000110', Tipo: 'BE AZ 16', Secção: '2 × 6 – 5×16' },
